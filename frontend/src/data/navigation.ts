...
const roleNav: Record<RoleName, NavItem[]> = {
  ...
  Coordinator: [
    ...
    { label: 'Daily Reports', to: '/app/daily-reports' },
    { label: 'Weekly Reports', to: '/app/weekly-reports' },
  ...
  Supervisor: [
    ...
    { label: 'Pending Daily Reports', to: '/app/daily-reports' },
    { label: 'Pending Weekly Reports', to: '/app/weekly-reports' },
