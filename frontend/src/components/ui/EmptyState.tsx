	...
	return (
		<div className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-slate-300 bg-slate-50/50 py-16 text-center dark:border-slate-600 dark:bg-slate-900/20">
			{icon ? (
				...
				<div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-lg bg-blue-100 text-blue-600 dark:bg-slate-700 dark:text-slate-300">
			...
			{description ? <p className="mx-auto mt-2 max-w-sm text-sm text-slate-700 dark:text-slate-300">{description}</p> : null}
