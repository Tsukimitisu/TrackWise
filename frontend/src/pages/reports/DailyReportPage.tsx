      ...
      <div className="max-w-6xl mx-auto p-6">
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="flex gap-2">
            ...
            <button
              onClick={() => navigate('/reports/daily/create')}
        ...
        <div className="mb-4 space-y-3">
          <input
            type="text"
            placeholder="Search by name, email, program, or tasks..."
            value={search}
        ...
        {loading ? (
          ...
          <div className="text-center py-8 text-gray-500">No daily reports found.</div>
        ) : (
              ...
              <tbody>
                {reports.map(report => (
                  <tr key={report.id} className="border-t hover:bg-gray-50">
                    ...
                    <td className="px-4 py-2 truncate max-w-xs">{report.tasks_done}</td>
                    <td className="px-4 py-2">
                    ...
                    <td className="px-4 py-2 flex gap-2">
                      <button
                        onClick={() => navigate(`/reports/daily/${report.id}`)}
                      ...
                      {report.status === 'draft' && (
                        <>
                          <button
                            onClick={() => navigate(`/reports/daily/${report.id}/edit`)}
